...
import no.nav.pensjon.vtp.server.api.journalforing.JournalforingRestTjeneste;
import no.nav.pensjon.vtp.server.api.kafka.KafkaRestTjeneste;
import no.nav.pensjon.vtp.server.api.sak.SakRestTjeneste;
import no.nav.pensjon.vtp.server.api.scenario.TestscenarioRestTjeneste;
import no.nav.pensjon.vtp.server.api.scenario.TestscenarioTemplateRestTjeneste;
import no.nav.pensjon.vtp.server.rest.IsAliveImpl;
import no.nav.pensjon.vtp.server.rest.IsReadyImpl;
import no.nav.pensjon.vtp.server.rest.PeproxyResource;
