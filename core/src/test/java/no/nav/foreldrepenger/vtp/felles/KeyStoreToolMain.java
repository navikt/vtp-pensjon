...
import static no.nav.foreldrepenger.vtp.felles.KeyStoreTool.KEYSTORE_FORMAT;
import static no.nav.foreldrepenger.vtp.felles.KeyStoreTool.getKeyAndCertAlias;
