...
public class HentInntektlisteBolkMapperRest {
    ...
    private static InntektType fraModellInntektstype(no.nav.pensjon.vtp.testmodell.inntektytelse.inntektkomponent.InntektType modellType) {
        if (modellType.equals(no.nav.pensjon.vtp.testmodell.inntektytelse.inntektkomponent.InntektType.LØNNSINNTEKT)) {
            return InntektType.LOENNSINNTEKT;
        }
        if (modellType.equals(no.nav.pensjon.vtp.testmodell.inntektytelse.inntektkomponent.InntektType.NÆRINGSINNTEKT)) {
            return InntektType.NAERINGSINNTEKT;
        }
        if (modellType.equals(no.nav.pensjon.vtp.testmodell.inntektytelse.inntektkomponent.InntektType.PENSJON_ELLER_TRYGD)) {
            return InntektType.PENSJON_ELLER_TRYGD;
        }
        if (modellType.equals(no.nav.pensjon.vtp.testmodell.inntektytelse.inntektkomponent.InntektType.YTELSE_FRA_OFFENTLIGE)) {
