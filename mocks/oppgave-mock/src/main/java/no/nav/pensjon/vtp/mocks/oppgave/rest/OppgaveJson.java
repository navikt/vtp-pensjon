...
import no.nav.pensjon.vtp.mocks.oppgave.rest.infrastruktur.validering.AtMostOneOf;
import no.nav.pensjon.vtp.mocks.oppgave.rest.infrastruktur.validering.AtleastOneOf;
import no.nav.pensjon.vtp.mocks.oppgave.rest.infrastruktur.validering.Organisasjonsnummer;
...
import static no.nav.pensjon.vtp.mocks.oppgave.rest.Oppgavestatus.FEILREGISTRERT;
import static no.nav.pensjon.vtp.mocks.oppgave.rest.Oppgavestatus.FERDIGSTILT;
